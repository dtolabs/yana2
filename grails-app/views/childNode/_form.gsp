...
<div class="fieldcontain ${hasErrors(bean: childNodeInstance, field: 'parent', 'error')} required">
	...
	<g:select id="parent" name="parent.id" from="${com.dtosolutions.Node.list()}" optionKey="id" required="" value="${childNodeInstance?.parent?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: childNodeInstance, field: 'child', 'error')} required">
	...
	<g:select id="child" name="child.id" from="${com.dtosolutions.Node.list()}" optionKey="id" required="" value="${childNodeInstance?.child?.id}" class="many-to-one"/>
</div>
