...
<html>
	...
	<body>
		<a href="#list-childNode" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-childNode" class="content scaffold-list" role="main">
			...
			<table>
				...
				<g:each in="${childNodeInstanceList}" status="i" var="childNodeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${childNodeInstance.id}">${fieldValue(bean: childNodeInstance, field: "parent")}</g:link></td>
