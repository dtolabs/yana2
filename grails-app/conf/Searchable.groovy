...
environments {
    ...
    production {
        searchable {
            if(System.properties["${appName}.searchindex.location"]){
                compassConnection = new File(System.properties["${appName}.searchindex.location"]).absolutePath
            }else if (org.codehaus.groovy.grails.commons.ConfigurationHolder.config.searchable.compassConnection) {
                compassConnection = new File(org.codehaus.groovy.grails.commons.ConfigurationHolder.config.searchable.compassConnection).absolutePath
            }else{
